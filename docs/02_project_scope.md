...
This project focuses on building a customer churn prediction system for an e-commerce business using historical transactional data. The scope is carefully defined to ensure the project is realistic, achievable within the given timeline, and aligned with business objectives.
...
Day 1–2: Business understanding, data acquisition, and data quality analysis

Day 3–4: Data cleaning, EDA, and feature engineering

Day  5–6: Model development, evaluation, and tuning

Day 7–8: Deployment, documentation, Dockerization, and final submission
